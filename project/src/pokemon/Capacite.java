...
public class Capacite implements interfaces.ICapacite {
    ...
    public int calculeDommage(interfaces.IPokemon lanceur, interfaces.IPokemon receveur) {
        ...
        double efficacite1 = 1;
        double efficacite2 = 1;
        if (lanceur.getEspece().getTypes()[0] != null && receveur.getEspece().getTypes()[0] != null) {
            efficacite1 =
                    pokedex.getEfficacite(
                            lanceur.getEspece().getTypes()[0], receveur.getEspece().getTypes()[0]);
        } else if (lanceur.getEspece().getTypes()[0] != null && receveur.getEspece().getTypes()[1] != null) {
            efficacite1 =
                    pokedex.getEfficacite(
                            lanceur.getEspece().getTypes()[0], receveur.getEspece().getTypes()[1]);
        } else if (lanceur.getEspece().getTypes()[1] != null && receveur.getEspece().getTypes()[0] != null) {
            efficacite2 =
                    pokedex.getEfficacite(
                            lanceur.getEspece().getTypes()[1], receveur.getEspece().getTypes()[0]);
        } else if (lanceur.getEspece().getTypes()[1] != null && receveur.getEspece().getTypes()[1] != null) {
            efficacite2 =
                    pokedex.getEfficacite(
                            lanceur.getEspece().getTypes()[1], receveur.getEspece().getTypes()[1]);
        } else {
            System.out.println("Oups ! An error occured !");
        }
